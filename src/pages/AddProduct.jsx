        ...
        <div className='border-2 w-2/3 flex flex-col bg-white shadow-lg gap-10 rounded-lg p-5 pb-8'>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <div>
              ...
              <input required={true} type='text' id="description" placeholder={"Enter Product Description"} name="description" value={product.description} onChange={handleChange} className="w-full rounded px-4 py-[6px] border-2 border-gray-400 focus:outline-none focus:border-blue-500" />
            </div>
